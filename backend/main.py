...
from controllers.code_writer_controller import router as code_writer_router
...
# Middleware for token checking and parsing
...
app.include_router(code_writer_router, prefix="/api/v1/code", tags=["Code Generator"])
