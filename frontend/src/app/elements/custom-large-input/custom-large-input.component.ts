...
@Component({
    selector: 'app-custom-large-input',
    imports: [
        NgClass,
        FormsModule,
        LoadingSpinnerComponent
    ],
    templateUrl: './custom-large-input.component.html',
    styleUrl: './custom-large-input.component.css'
})
export class CustomLargeInputComponent {
    ...
    @ViewChild("thisinput") thisInput!: ElementRef<HTMLTextAreaElement> | undefined;
    ...
    onInput(event: Event): void {
        ...
        this.valueChangeDefault.emit((event.target as HTMLTextAreaElement).value);
